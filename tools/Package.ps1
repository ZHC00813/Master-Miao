...
$packageRoot = Join-Path $outputRoot 'Master-Miao-v1.2.6-0905-R4'
$archivePath = Join-Path $outputRoot 'Master-Miao-v1.2.6-0905-R4.zip'
...
if ([Diagnostics.FileVersionInfo]::GetVersionInfo((Join-Path $buildRoot 'MasterMiao.exe')).FileVersion -ne '1.2.6.4') { throw 'Build is not revision 0905-R4.' }
...
$documents = @('README.md','README.en.md','ARCHITECTURE.md','DEVELOPMENT_HISTORY.md','V1.2.5_COMPATIBILITY_AUDIT.md','V1.2.6_CHANGES.md','R2_FIX_VALIDATION.md','R3_CHANGES_AND_TESTS.md','R4_UI_NOTES.md','VALIDATION.md','ACCEPTANCE_CHECKLIST.md','TEST_RESULT.txt','THIRD_PARTY_NOTICE.md')
